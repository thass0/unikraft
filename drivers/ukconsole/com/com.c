...
#if CONFIG_LIBUKCONSOLE_COM1_BAUD_19200
#define COM1_BAUDDIV_LO 0x04
#elif CONFIG_LIBUKCONSOLE_COM1_BAUD_38400
#define COM1_BAUDDIV_LO 0x03
#elif CONFIG_LIBUKCONSOLE_COM1_BAUD_57600
#define COM1_BAUDDIV_LO 0x02
#elif CONFIG_LIBUKCONSOLE_COM1_BAUD_115200
#define COM1_BAUDDIV_LO 0x01
#endif

#if CONFIG_LIBUKCONSOLE_COM2_BAUD_19200
#define COM2_BAUDDIV_LO 0x04
#elif CONFIG_LIBUKCONSOLE_COM2_BAUD_38400
#define COM2_BAUDDIV_LO 0x03
#elif CONFIG_LIBUKCONSOLE_COM2_BAUD_57600
#define COM2_BAUDDIV_LO 0x02
#elif CONFIG_LIBUKCONSOLE_COM2_BAUD_115200
#define COM2_BAUDDIV_LO 0x01
#endif

#if CONFIG_LIBUKCONSOLE_COM3_BAUD_19200
#define COM3_BAUDDIV_LO 0x04
#elif CONFIG_LIBUKCONSOLE_COM3_BAUD_38400
#define COM3_BAUDDIV_LO 0x03
#elif CONFIG_LIBUKCONSOLE_COM3_BAUD_57600
#define COM3_BAUDDIV_LO 0x02
#elif CONFIG_LIBUKCONSOLE_COM3_BAUD_115200
#define COM3_BAUDDIV_LO 0x01
#endif

#if CONFIG_LIBUKCONSOLE_COM4_BAUD_19200
#define COM4_BAUDDIV_LO 0x04
#elif CONFIG_LIBUKCONSOLE_COM4_BAUD_38400
#define COM4_BAUDDIV_LO 0x03
#elif CONFIG_LIBUKCONSOLE_COM4_BAUD_57600
#define COM4_BAUDDIV_LO 0x02
#elif CONFIG_LIBUKCONSOLE_COM4_BAUD_115200
#define COM4_BAUDDIV_LO 0x01
#endif

#if CONFIG_LIBUKCONSOLE_COM1_EARLY
#define COM_EARLY_PORT	COM1_PORT
#define COM_EARLY_NAME	"COM1"
#define COM_EARLY_BAUDDIV_LO COM1_BAUDDIV_LO
#endif /* CONFIG_LIBUKCONSOLE_COM1_EARLY */
#if CONFIG_LIBUKCONSOLE_COM2_EARLY
#define COM_EARLY_PORT	COM2_PORT
#define COM_EARLY_NAME	"COM2"
#define COM_EARLY_BAUDDIV_LO COM2_BAUDDIV_LO
#endif /* CONFIG_LIBUKCONSOLE_COM2_EARLY */
#if CONFIG_LIBUKCONSOLE_COM3_EARLY
#define COM_EARLY_PORT	COM3_PORT
#define COM_EARLY_NAME	"COM3"
#define COM_EARLY_BAUDDIV_LO COM3_BAUDDIV_LO
#endif /* CONFIG_LIBUKCONSOLE_COM3_EARLY */
#if CONFIG_LIBUKCONSOLE_COM4_EARLY
#define COM_EARLY_PORT	COM4_PORT
#define COM_EARLY_NAME	"COM4"
#define COM_EARLY_BAUDDIV_LO COM4_BAUDDIV_LO
#endif /* CONFIG_LIBUKCONSOLE_COM4_EARLY */
...
#if CONFIG_LIBUKCONSOLE_COM_EARLY_CONSOLE
...
#endif /* CONFIG_LIBUKCONSOLE_COM_EARLY_CONSOLE */
...
#if CONFIG_LIBUKCONSOLE_COM1 && !CONFIG_LIBUKCONSOLE_COM1_EARLY
	rc = com_init_port(a, "COM1", COM1_PORT,
			   COM1_BAUDDIV_LO, COM_BAUDDIV_HI);
	if (unlikely(rc < 0))
		return rc;
#endif /* CONFIG_LIBUKCONSOLE_COM1 && !CONFIG_LIBUKCONSOLE_COM1_EARLY */
#if CONFIG_LIBUKCONSOLE_COM2 && !CONFIG_LIBUKCONSOLE_COM2_EARLY
	rc = com_init_port(a, "COM2", COM2_PORT,
			   COM2_BAUDDIV_LO, COM_BAUDDIV_HI);
	if (unlikely(rc < 0))
		return rc;
#endif /* CONFIG_LIBUKCONSOLE_COM2 && !CONFIG_LIBUKCONSOLE_COM2_EARLY */
#if CONFIG_LIBUKCONSOLE_COM3 && !CONFIG_LIBUKCONSOLE_COM3_EARLY
	rc = com_init_port(a, "COM3", COM3_PORT,
			   COM3_BAUDDIV_LO, COM_BAUDDIV_HI);
	if (unlikely(rc < 0))
		return rc;
#endif /* CONFIG_LIBUKCONSOLE_COM3 && !CONFIG_LIBUKCONSOLE_COM3_EARLY */
#if CONFIG_LIBUKCONSOLE_COM4 && !CONFIG_LIBUKCONSOLE_COM4_EARLY
	rc = com_init_port(a, "COM4", COM4_PORT,
			   COM4_BAUDDIV_LO, COM_BAUDDIV_HI);
	if (unlikely(rc < 0))
		return rc;
#endif /* CONFIG_LIBUKCONSOLE_COM4 && !CONFIG_LIBUKCONSOLE_COM4_EARLY */
